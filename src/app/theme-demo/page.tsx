        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-text-secondary max-w-2xl mx-auto">
              Experience our three carefully crafted themes designed for
              heritage conservation, professional surveying, and digital
          ...
          <div className="text-center">
            <Card className="p-8 bg-bg-secondary">
              ...
              <p className="text-text-secondary max-w-3xl mx-auto">
                Our themes are carefully crafted to reflect the values of
                heritage conservation: respect for tradition, professional
                excellence, and a deep appreciation for the historical
                significance of the work we do. Each color palette tells a story
                of preservation, accuracy, and reverence for the past.
              </p>
            </Card>
          </div>
        </div>
